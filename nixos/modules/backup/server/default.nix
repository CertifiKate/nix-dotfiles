...
in {
  options.CertifiKate.modules.backup_server.enable = lib.mkEnableOption "Enable backup server configuration";

  config = lib.mkIf config.CertifiKate.modules.backup_server.enable {
